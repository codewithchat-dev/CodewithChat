  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center p-4 md:p-8 overflow-y-auto">
      ...
      <div className="w-full max-w-6xl flex-1 flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-700 pt-10 pb-20">
        ...
        <div className="w-full mt-10 rounded-2xl border border-border/60 bg-card/40 backdrop-blur-sm p-6 shadow-sm" style={{ backgroundImage: 'radial-gradient(oklch(0.55 0 0 / 0.08) 1px, transparent 1px)', backgroundSize: '18px 18px' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {projects.slice(0, showAll ? projects.length : 8).map((project, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="h-36 w-full border-b border-border/50 flex items-end justify-center overflow-hidden relative p-4 pb-0" style={{ background: `linear-gradient(160deg, oklch(${0.12 + (i % 4) * 0.03} 0 0) 0%, oklch(0.18 0 0) 100%)` }}>
                    <button 
                    ...
                    <div 
                      ...
                      style={{ background: `radial-gradient(ellipse at 30% 0%, oklch(${0.55 + (i % 4) * 0.05} 0 0 / 0.15), transparent 70%)` }} 
                    />
