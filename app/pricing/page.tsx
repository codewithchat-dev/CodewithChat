      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-4 py-16 md:py-24">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            Start building for free. Upgrade when you need more power, priority
            access, and unlimited credits.
          </p>
          ...
          <div className="flex items-center gap-3 mt-8">
            ...
            >
              Yearly{" "}
              <span className="ml-1 rounded-full bg-green-500/20 text-green-500 px-2 py-0.5 text-xs font-bold">
                Save 20%
              </span>
            </span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto relative z-10">
          ...
          <div className="flex flex-col rounded-2xl border-2 border-primary bg-card p-8 shadow-xl relative md:scale-105 z-20">
            ...
            <div className="mb-6">
              ...
              <p className="mt-4 text-sm text-muted-foreground">
                {isYearly ? "Billed $96 annually. " : ""}For developers shipping
        ...
        <div className="mt-32 max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">
              Run out of monthly credits? Top up instantly without changing your
              subscription tier.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-border bg-card overflow-hidden shadow-sm">
            <div className="grid grid-cols-3 gap-4 p-6 border-b border-border bg-muted/30">
              ...
              <div className="font-semibold text-sm text-muted-foreground text-right">
                Action
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 p-6 border-b border-border items-center">
              <div className="font-medium flex flex-col md:flex-row md:items-center gap-1 text-sm md:text-base">
                500 Extra Credits
                <span className="w-fit text-[10px] md:text-xs text-green-500 bg-green-500/10 px-2 py-0.5 rounded-full font-bold">
                  Save 10%
                </span>
              </div>
