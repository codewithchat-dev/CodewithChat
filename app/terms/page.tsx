...
export const metadata = {
  ...
  description:
    "Read the rules, rights, and legal guidelines governing your use of the CodewithChat platform.",
};
        ...
        <section className="relative overflow-hidden pt-32 pb-20 border-b border-border/40 bg-gradient-to-b from-background via-background/95 to-background/50">
          ...
          <div className="mx-auto max-w-5xl px-6 relative z-10">
            ...
            <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-3xl leading-relaxed">
              Welcome to CodewithChat. Please review the rules, guidelines, and
              legal frameworks that govern your access and use of our platform.
            </p>
            ...
            <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-3">
              <div className="p-6 rounded-2xl border border-border/80 bg-card/60 backdrop-blur-md transition-all duration-300 hover:border-primary/40 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/5">
                ...
                <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
                  We expect all builders to avoid using the platform for
                  malicious code generation or abusive rates.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl border border-border/80 bg-card/60 backdrop-blur-md transition-all duration-300 hover:border-primary/40 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/5">
                ...
                <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
                  You retain full, exclusive ownership of any application code
                  or designs created on our service.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl border border-border/80 bg-card/60 backdrop-blur-md transition-all duration-300 hover:border-primary/40 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/5">
                ...
                <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
                  Simple pay-as-you-go subscriptions. Cancel anytime through
                  your customer billing dashboard.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-16 max-w-none text-muted-foreground">
              ...
              <section id="agreement" className="scroll-mt-28 group">
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  <p>
                    By accessing, registering, or using the CodewithChat
                    website, software, or integrations, you agree to be bound by
              ...
              <section id="accounts" className="scroll-mt-28 group">
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  <p>
                    To access the AI-assisted code generation platform, you must
                  ...
                  <ul className="list-disc list-inside space-y-2 pl-2">
                    <li>
                      ...
                      Account validation is managed through Clerk. You agree to
                      safeguard your password and credentials.
                    </li>
                    <li>
                      <strong className="text-foreground">Accuracy:</strong> You
                    ...
                    <li>
                      ...
                      You are responsible for any activities occurring under
              ...
              <section id="license-conduct" className="scroll-mt-28 group">
                <div className="flex items-center gap-2 text-foreground mb-4">
                  ...
                  <h2 className="text-2xl font-bold tracking-tight text-foreground m-0">
                    3. Platform Conduct & Usage License
                  </h2>
                </div>
                <div className="space-y-4 text-base leading-relaxed">
                  <p>
                    We grant you a personal, non-transferable, revocable license
                    to access our editor, chat interface, and template workspace
                    in accordance with these Terms. Under this license, you may
                    not:
                  </p>
                  <ul className="list-disc list-inside space-y-2 pl-2">
                    <li>
                      Decompile, reverse-engineer, or attempt to extract the
                      proprietary source code of the CodewithChat orchestrator
                      and backend servers.
                    </li>
                    <li>
                      Use our AI services to systematically scrape, extract, or
                      hoard raw dataset parameters to train competing
                      programming LLMs.
                    </li>
                    <li>
                      Bypass, disable, or circumvent safety filters, API request
                      limits, or user authentication headers.
                    </li>
                    <li>
                      Deploy automated bots to generate accounts or submit
                      massive concurrent prompts.
                    </li>
                  </ul>
                  <p>
                    Violations of acceptable conduct will result in immediate
                    termination of account access without refunds.
                  </p>
                </div>
              </section>
              ...
              <section id="ai-outputs" className="scroll-mt-28 group">
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  <p>
                    The relationships and terms regarding synthesized software
                    output are governed as follows:
                  </p>
                  <ul className="list-disc list-inside space-y-2 pl-2">
                    <li>
                      <strong className="text-foreground">
                      ...
                      You own all intellectual property rights, file
                      repositories, and distribution rights to the code snippets
                      or apps synthesized for you.
                    </li>
                    <li>
                      <strong className="text-foreground">
                        No Representation:
                      </strong>{" "}
                      CodewithChat does not guarantee that the generated code is
                      error-free, secure, or free from functional regressions.
                    </li>
                    <li>
                      <strong className="text-foreground">
                        Developer Responsibility:
                      </strong>{" "}
                      You are responsible for ensuring that your code behaves
                      correctly in local environments and production stacks.
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section id="subscriptions" className="scroll-mt-28 group">
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  <p>
                    We offer subscription plans with monthly or annual billing
                    terms:
                  </p>
                  <ul className="list-disc list-inside space-y-2 pl-2">
                    <li>
                      ...
                      All processing is done through Stripe. Recurring charges
                      are collected at the start of each billing cycle.
                    </li>
                    <li>
                      <strong className="text-foreground">Cancellation:</strong>{" "}
                      You can cancel your subscription at any time. You will
                      continue to have access to the premium tiers until the end
                    ...
                    <li>
                      ...
                      dissatisfied with our service, contact billing support
              ...
              <section id="disclaimers" className="scroll-mt-28 group">
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  <p className="bg-muted/40 p-4 rounded-xl border border-border text-foreground font-medium">
                    THE MATERIALS AND SERVICES ON CODEWITHCHAT'S WEBSITE ARE
                    PROVIDED ON AN 'AS IS' AND 'AS AVAILABLE' BASIS.
                    CODEWITHCHAT MAKES NO WARRANTIES, EXPRESSED OR IMPLIED, AND
                  ...
                  <p>
                    Further, CodewithChat does not warrant or make any
                    representations concerning the accuracy, likely results, or
                    reliability of the use of materials on its website or
              ...
              <section id="liability" className="scroll-mt-28 group">
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  <p>
                    IN NO EVENT SHALL CODEWITHCHAT, ITS PARTNERS, OR ITS SERVICE
                    PROVIDERS BE LIABLE FOR ANY DAMAGES (INCLUDING, WITHOUT
                    LIMITATION, DAMAGES FOR LOSS OF DATA OR PROFIT, OR DUE TO
                    BUSINESS INTERRUPTION) ARISING OUT OF THE USE OR INABILITY
                    TO USE CODEWITHCHAT'S SERVICE, EVEN IF CODEWITHCHAT HAS BEEN
              ...
              <section id="governing-law" className="scroll-mt-28 group">
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  <p>
                    ...
                    accordance with the local laws governing our company
                    registration, without regard to its conflict of law
                    provisions.
                  </p>
                  <p>
                    You irrevocably submit to the exclusive jurisdiction of the
                    state and federal courts in that region to resolve any
              ...
              <section id="contact" className="scroll-mt-28 group">
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  <p>
                    ...
                    help with your account billing, please contact us:
                  </p>
