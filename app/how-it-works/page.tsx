...
export const metadata = {
  ...
  description:
    "See how CodewithChat transforms your ideas into deployed, production-grade applications in three simple steps.",
};
...
const detailedSteps = [
  {
    ...
    example:
      '"Build me a SaaS dashboard with user auth, a billing page, and analytics charts"',
  },
  {
    step: "02",
    icon: PenTool,
    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground selection:bg-primary/20">
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden pt-32 pb-20 border-b border-border/40 bg-gradient-to-b from-background via-background/95 to-background/50">
          ...
          <div className="mx-auto max-w-5xl px-6 relative z-10 text-center">
            ...
            <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              From a simple text prompt to a fully deployed SaaS application —
              here's exactly how CodewithChat builds your software.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 lg:py-28 mx-auto max-w-4xl px-6">
          ...
          <p className="text-muted-foreground mb-16 text-center max-w-2xl mx-auto">
            A detailed look at what happens from the moment you type your idea
            to launch day.
          </p>
            ...
            {detailedSteps.map((s) => (
              <div key={s.step} className="flex gap-6 group">
                ...
                <div className="pb-10">
                  ...
                  {"example" in s && (
                    <p className="mt-3 text-xs font-mono bg-muted/40 p-3 rounded-xl border border-border text-foreground/80 italic">
                      {s.example}
                    </p>
                  )}
                </div>
        ...
        <section className="py-20 text-center bg-muted/20">
          <div className="mx-auto max-w-2xl px-6">
            ...
            <p className="text-muted-foreground mb-8">
              The best way to understand the process is to experience it. Start
              with a free account.
            </p>
            <Button
              asChild
