...
export const metadata = {
  ...
  description:
    "Deploy CodewithChat securely in your VPC, fine-tune models on your private repositories, and scale software development with enterprise guardrails.",
};
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-6 text-left">
                ...
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  Bring CodewithChat inside your company boundaries. Train
                  custom AI engines on your private code bases and host the
                  builder safely inside your secure VPC.
                </p>
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
              ...
              <p className="text-muted-foreground text-base">
                While standard AI tools expose codebases to public API
                telemetry, CodewithChat Enterprise sets strict security
                parameters to protect corporate IP.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="p-8 rounded-3xl border border-border bg-card/60 backdrop-blur-sm relative overflow-hidden transition-all duration-300 hover:border-primary/40 hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/5">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Run the code sandbox engine, database sync hooks, and AI
                  orchestrators directly within your AWS, GCP, Azure, or
              ...
              <div className="p-8 rounded-3xl border border-border bg-card/60 backdrop-blur-sm relative overflow-hidden transition-all duration-300 hover:border-primary/40 hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/5">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Fine-tune secure models using your private repositories,
                  design system components, styling templates, and custom API
                  SDK definitions.
                </p>
              </div>
              ...
              <div className="p-8 rounded-3xl border border-border bg-card/60 backdrop-blur-sm relative overflow-hidden transition-all duration-300 hover:border-primary/40 hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/5">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Utilize SAML/SSO authentication, assign Role-Based Access
                  Controls (RBAC), view audit histories, and set spending limits
                  on team tokens.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="p-8 rounded-3xl border border-border/80 bg-card/40 backdrop-blur-md relative overflow-hidden aspect-video flex flex-col justify-center gap-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Workspace codes compile in temporary, local client-side memory
                  blocks. Absolute control over what telemetry is transmitted to
                  backend endpoints.
                </p>
              </div>
              ...
              <div className="mt-4 p-4 border border-border rounded-xl bg-background/50 flex flex-col gap-2">
                <div className="flex justify-between items-center text-xs">
                  ...
                  <span className="font-semibold text-foreground">
                    Google Gemini 1.5 Pro (Private VPC)
                  </span>
                </div>
                <div className="flex justify-between items-center text-xs">
            ...
            <div className="space-y-6">
              ...
              <p className="text-base text-muted-foreground leading-relaxed">
                When deploying CodewithChat at scale, we guarantee absolute
                support. Our technical and business pipelines offer:
              </p>
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Legally binding SLA guarantees on orchestrator uptime and
                      local workspace compiler sync tools.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      A named point of contact to assist with pipeline setups,
                      local VPC deployments, and custom LLM tuning.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Periodic external penetration tests, code scanning
                      vulnerability charts, and SOC 2 Type II assurance
                      documentation.
                    </p>
                  </div>
                </div>
