...
export const metadata = {
  ...
  description:
    "Understand how CodewithChat collects, processes, and protects your personal and technical data.",
};
        ...
        <section className="relative overflow-hidden pt-32 pb-20 border-b border-border/40 bg-gradient-to-b from-background via-background/95 to-background/50">
          ...
          <div className="mx-auto max-w-5xl px-6 relative z-10">
            ...
            <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-3xl leading-relaxed">
              At CodewithChat, transparent data practices are the foundation of
              our engineering. Learn how we collect, secure, and handle your
              information.
            </p>
            ...
            <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-3">
              <div className="p-6 rounded-2xl border border-border/80 bg-card/60 backdrop-blur-md transition-all duration-300 hover:border-primary/40 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/5">
                ...
                <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
                  Request access, export, or permanently delete your account
                  history and settings anytime.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl border border-border/80 bg-card/60 backdrop-blur-md transition-all duration-300 hover:border-primary/40 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/5">
                ...
                <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
                  ...
                  codebase files to third parties.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl border border-border/80 bg-card/60 backdrop-blur-md transition-all duration-300 hover:border-primary/40 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/5">
                ...
                <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
                  All authentication and billing data are protected by industry
                  leaders (Clerk and Stripe).
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-16 max-w-none text-muted-foreground">
              ...
              <section id="introduction" className="scroll-mt-28 group">
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  <p>
                    Your privacy is critically important to us. It is
                    CodewithChat's policy to respect your privacy regarding any
                    information we may collect from you across our website and
                    desktop integration points.
                  </p>
                  <p>
                    We only request personal information when it is genuinely
                    necessary to deliver a high-quality service. We collect it
                    by fair and lawful means, with your clear knowledge and
                    consent. This document clarifies what we collect, how it is
                    managed, and how we protect your personal and development
                    telemetry.
                  </p>
                </div>
              </section>
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  ...
                  <ul className="list-disc list-inside space-y-2 pl-2">
                    <li>
                      ...
                      When you register on CodewithChat, we collect account
                      credentials (such as your name, email address, and profile
                      picture) handled securely via our authentication partner,
                      Clerk.
                    </li>
                    <li>
                      <strong className="text-foreground">
                      ...
                      To run chat sessions and guide you, we process code
                      snippets, files, prompts, and config details that you
                      submit.
                    </li>
                    <li>
                      <strong className="text-foreground">
                      ...
                      Subscriptions and billing information are collected
                      directly and securely processed by Stripe. We do not store
                    ...
                    <li>
                      ...
                      We automatically log details about your browser, operating
                      system, IP address, and platform usage to troubleshoot
              ...
              <section id="data-usage" className="scroll-mt-28 group">
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  <p>
                    We utilize your data strictly to maintain, improve, and
                    secure the CodewithChat experience:
                  </p>
                  <ul className="list-disc list-inside space-y-2 pl-2">
                    <li>
                      Providing code recommendations, project structure
                      guidelines, and chat assistance.
                    </li>
                    <li>
                      Authenticating your account and managing subscription
                      access.
                    </li>
                    <li>
                      Analyzing usage metrics to identify bug hotspots and
                      refine user flows.
                    </li>
                    <li>
                      Blocking malicious software generation, spam abuse, or
                      security breaches.
                    </li>
                  </ul>
                </div>
              ...
              <section id="data-sharing" className="scroll-mt-28 group">
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  <p>
                    ...
                    only share data with verified subprocessors strictly
                    required to operate our service:
                  </p>
                  <ul className="list-disc list-inside space-y-2 pl-2">
                    <li>
                      <strong className="text-foreground">Clerk:</strong> For
                      identity verification and sign-in management.
                    </li>
                    <li>
                      <strong className="text-foreground">Supabase:</strong> As
                      our primary secure cloud database provider.
                    </li>
                    <li>
                      <strong className="text-foreground">
                        Google Vertex AI / Gemini API:
                      </strong>{" "}
                      To process prompt queries and generate responsive codebase
                      setups.
                    </li>
                    <li>
                      <strong className="text-foreground">Stripe:</strong> For
                      secure invoice generation and payment clearance.
                    </li>
                  </ul>
                  <p>
                    All third-party services are contractually bound under
                    strict Data Processing Agreements (DPAs) that prohibit them
              ...
              <section id="data-retention" className="scroll-mt-28 group">
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  <p>
                    ...
                    provide your requested services. When data is no longer
                    required, we perform secure, irreversible deletions.
                  </p>
                  <p>
                    At any time, you can request full deletion of your profile,
                    projects, and chat logs by contacting our support team or
                    using the dashboard settings. Account deletion is fully
                    completed across all database tables and integrations within
              ...
              <section id="cookies" className="scroll-mt-28 group">
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  <p>
                    We use cookies and equivalent local storage items strictly
                    to preserve your sign-in session and store UI preferences
                    (like Dark/Light mode status).
                  </p>
                  <p>
                    We do not deploy invasive cross-site advertising trackers.
                    You can disable cookies in your browser settings, though
                    doing so will prevent you from signing in or maintaining
              ...
              <section id="user-rights" className="scroll-mt-28 group">
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  <p>
                    Regardless of your geographic location, we respect your
                  ...
                  <ul className="list-disc list-inside space-y-2 pl-2">
                    <li>
                      ...
                      You can request a breakdown of what personal data we have
                      stored.
                    </li>
                    <li>
                      <strong className="text-foreground">
                      ...
                      You can update inaccurate profile configurations.
                    </li>
                    <li>
                      <strong className="text-foreground">
                        Right of Erasure:
                      </strong>{" "}
                      You can command permanent deletion of your data.
                    </li>
                    <li>
                      <strong className="text-foreground">
                        Right to Portability:
                      </strong>{" "}
                      You can request your historical project details in a
              ...
              <section id="contact" className="scroll-mt-28 group">
                ...
                <div className="space-y-4 text-base leading-relaxed">
                  <p>
                    If you have questions about how we handle user data, secure
                    our APIs, or if you would like to request data deletion,
                    please contact us:
                  </p>
