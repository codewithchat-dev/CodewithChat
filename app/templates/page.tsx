...
export const metadata = {
  ...
  description:
    "Browse starter templates for SaaS dashboards, e-commerce stores, AI chat interfaces, portfolios, and more. Click to build instantly.",
};
        ...
        <section className="relative overflow-hidden pt-32 pb-20 border-b border-border/40 bg-gradient-to-b from-background via-background/95 to-background/50">
          ...
          <div className="mx-auto max-w-5xl px-6 relative z-10 text-center">
            ...
            <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Don't start from scratch. Pick a professionally designed template
              and let the AI customize it to your exact vision.
            </p>
          </div>
        </section>
